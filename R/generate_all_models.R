...
#' @examples
#' \dontrun{
#' model_input <- filter_model_input(model_input = samp, flagged_alleles = flagged_alleles,
#' filter_cosmic_mutations = TRUE, cosmic_mutations = hemeCOSMIC, cosmic_mut_frequency = 10)
